...
describe "A registered user" do
  it "can send an invite email to someone via their GitHub username with an email" do
    ...
    user = create(:user, github_token: ENV["LEIYA_GITHUB_API_KEY"], github_username: 45922590, first_name: "Leiya", last_name: "Kenney")
  ...
  # it "can send an invite email to someone via their GitHub username without an email" do
