...
describe 'A registered user' do
  it 'can add friends', :vcr do
    ...
    user = create(:user, github_token: ENV['GITHUB_API_KEY'], github_username: 49_769_068, first_name: 'Josh', last_name: 'Sherwood')
    user_2 = create(:user, github_token: ENV['LEIYA_GITHUB_API_KEY'], github_username: 45_922_590, first_name: 'Leiya', last_name: 'Kenney')
